...
| `word` | `skills/word` | 通用技术文档撰写，注重专业口吻、权衡驱动的工程叙事与严谨注意事项（适用架构文档、系统设计、白皮书、Markdown、Word、PDF 等全载体） | `$word` |
...
- **核心特色**：拒绝套话与刻板八股。强调沉稳客观的工程师口吻、以“约束与权衡”为核心的叙事手法、因果递进推导、公式参数正下方即刻交代与符号唯一性、实测边界与异常安全兜底，并在涉及 Word/PDF 导出时保证原生 OMML 矢量公式排版。
