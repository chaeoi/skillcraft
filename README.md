...
- **核心特色**：拒绝套话与刻板八股。强调沉稳客观的工程师口吻、以“约束与权衡”为核心的叙事手法、因果递进推导、公式参数正下方即刻交代与符号唯一性、实测边界与异常安全兜底，并在涉及 Word/PDF 导出时保证原生 OMML 矢量公式排版与标准工程报告格式系统（A4 装订版心、宋体小四号单倍行距、首行缩进 2 字符、黑体标题梯队、0.5 磅细实线表格及居中图表题注）。
